				...
				<div class="container pb-5">
						<div class="title-container">
							<div class="text-center heading-section">
								<h2 class="page-title">일지 등록</h2>
								<form action="/petsitting/p003/walkregister" class="walkform" align="right">
			                       	<input type="hidden" name="reservation_ID" value="${reservation_ID }">
			                       	<input type="submit" class="walkbtn" value='산책등록'>
								</form>
							</div>
	                    </div>
						...
						<div class="info-part1">
							...
							<div class="info-part1--contents" align="center">
								...
								<form action="/petsitting/p003/logregisterdata" method="post" enctype="multipart/form-data">
									<input type="hidden" name="reservation_ID" value="${reservation_ID }">
									<input type="hidden" name="log_Type" value="nomal">
